...
public class ForeCastAPI {
    ...
    public ArrayList<String> getDateAndTimeL(){
        return dateL;
    }
    public ArrayList<String> getMainTempL(){
        return this.mainTempL;
    }
    public ArrayList<Integer> getIconL(){
        ArrayList<Integer> iconL = new ArrayList<>();
        HashMap<String, Integer> icons = new HashMap<>();
        icons = WeatherTypes.getIcons(icons);
        for (String desc: iconDescL) {
            iconL.add(icons.get(desc));
        }
        return iconL;
    }
    public ArrayList<String> getTimeL(){
        ArrayList<String> timeA = new ArrayList<>();
        for (String elt: dateL) {
            timeA.add(elt.substring(11, 16));
        }
        return timeA;
    }
